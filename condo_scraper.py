...
# URL = "http://v3.torontomls.net/Live/Pages/Public/Link.aspx?Key=308e59ae90374ce790156b951eb7c73e&App=TREB"
...
DATA_FIELDS = {
    ...
    "locker_num": "Locker#:",
    "num_shares_percent": "#Shares%:",
    "total_area": "Total Area:",
    "zoning": "Zoning:",
    "nearest_intersection": "Dir/Cross St:",
...
def get_building_info_and_type(report):
    pass
    # global extracted_data
    # infos_and_type = [e.string or "" for e in
    #                   report.find(text="Freestanding:").parent.parent.find_all_previous("span", "value", limit=3)]
    # extracted_data['building_info'] = infos_and_type[
    #     2] + " " + infos_and_type[1]
    # extracted_data['building_business'] = infos_and_type[0]
...
def scrape_url(url, report_index):
    ...
    output_csv_file = "condo_commercial_%d.csv" % report_index
